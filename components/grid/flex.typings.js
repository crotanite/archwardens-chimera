...
exports.definedProps = __assign(__assign(__assign({}, useAlignProps_1.alignProps({ items: 'items-start', justify: 'justify-start' })), useColumnsProps_1.columnsProps({ columns: null })), useGapProps_1.gapProps({ gap: 'gap-3' }));
